...
Normalizes, filters, converts currency, applies message/image overrides, and reconstructs recurring cash flow.
"""
    ...
    def _load_events(self, path: str):
        with open(path, 'r', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                # Ignore failed, cancelled, unrealized
                ...
                # Handle blank amount via ImageExtractor
                ...
                home_curr = profile.home_currency if profile else curr
                ...
                self.user_events[uid].append(event)
